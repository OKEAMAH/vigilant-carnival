...
- The `text` value of {{cssxref("background-clip")}} is now available in all types of Firefox (and not only non-release builds) ([Firefox bug 1263516](https://bugzil.la/1263516)).
...
- The deprecated old Proxy API (`Proxy.create` and `Proxy.createFunction()`) has been removed. Use the standard {{jsxref("Proxy")}} object instead ([Firefox bug 892903](https://bugzil.la/892903)).
